...
class RestartMenu():
    def __init__(self, function_args, screen_size = snake_rules.screen_size):
        x_diff = 130
        y_diff = 120
        offset = (0, 0)
        ...
        text = ["Restart", "Main Menu", "Only AI", "Learning", "Map Builder", "bababa","oppai", "AI vs Player", "Only AI", "Learning", "Map Builder", "bababa"]


        self.button_set = ButtonSet((x_frame,y_frame), 5, 5, 0, 4,1,2,text, colors, s_colors, 0, function_args)
